...
convnet = input_data(shape=[None, preprocessing.IMG_SIZE, preprocessing.IMG_SIZE, 1], name='input')
...
model.fit({'input': X}, {'targets': Y}, n_epoch=3, validation_batch_size=0.1,
