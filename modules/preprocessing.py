...
TRAINING_DATA_DIR = r"/Users/emilny/Downloads/Data/train/"
TEST_DATA_DIR = r"/Users/emilny/Downloads/Data/test/"
...
def create_dataset(percentage_of_data_set=1., training=True, augmented=False):
    ...
    if training:
        np.save(r'./data_np/training_data', x_data)
        np.save(r'./data_np/training_labels', y_data)
        print("Training data saved!")

    else:
        np.save(r"./data_np/test_data", x_data)
        np.save(r"./data_np/test_labels", y_data)
